...
unset($__errorArgs, $__bag); ?>" id="nrp" placeholder="Masukkan NRP" name="nrp">
                        <?php $__errorArgs = ['nrp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/danialsyafiq/Code/PHP/LaravelPro/resources/views/students/create.blade.php ENDPATH**/ ?>